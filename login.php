...
if (isset($_POST['login'])) {
	...
	if ($row = mysqli_fetch_array($result)) {
		...
		if(!empty($_POST["remember"])) {
			if($temp_key == NULL){
				if(mysqli_query($con, "UPDATE users SET last_login = '" .$timeNow. "' , login_hash = '" .$key."' WHERE email = '" . $email. "' and password = '" . md5($password) . "' ")){
...
<head>
  ...
  <title> Power Solution Madhyamgram | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Power Solution </b>Madhyamgram</a>
  </div>
  <!-- /.login-logo -->
 ...
 <br>
    <!--<center><span class="fa fa-backward"> Back to <a href="http://priyamdeyphysics.org">Priyam Dey - Physics</a></span></center> -->

  </div>
  <!-- /.login-box-body -->  
</div>
<!-- /.login-box -->
<center>&copy; 2018-19 Prodip Paul & Snehasis Biswas | Created by <a href="http://mindwebs.org" target="_blank">MinD Webs Team</a></center>
