...
<head>
  ...
  <title> PDP | Results Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="ion ion-edit"></i>Topics</a></li>
        <li>User</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <input type="text" class="form-control" placeholder="">
                ...
                <div class="col-lg-6">
                  <div class="form-group has-feedback">
                    <label for="exampleInputText">Class</label>
        <input type="text" class="form-control" placeholder="">
         </div>
                </div>
<div class="col-lg-12">
                  <div class="form-group has-feedback">
                    <label for="exampleInputText">Topic</label>
        <input type="text" class="form-control" placeholder="">
         </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group has-feedback">
                    <label for="exampleInputText">Subtopic</label>
        <input type="text" class="form-control" placeholder="">
         </div>
                </div>
 ...
 <div class="row">
        ...
        ?>
                <tr>
                  ...
                  <td><?php ?></td>
                  <td>
                  <a href="#"><button type="button" class="btn btn-primary">MODIFY</button></a>
