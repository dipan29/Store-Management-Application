  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="view-tests.php"><i class="ion ion-laptop"></i>View Tests</a></li>
		<li><a href="#"><i class="ion ion-laptop"></i>View Question</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info" style="overflow-x:scroll">
            <div class="box-header">
              ...
              <h3 class="box-title">Questions (Paper Code : <?php echo $id; ?>)</h3>            
            ...
            <div class="box-body">
                ...
                <tbody>
                <?php 
					$result = mysqli_query($con, "SELECT * FROM qnskey WHERE p_code = '".$id."' ORDER BY q_code ");
					if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) { 
				?>
                <tr>
                  <td><?php echo $row['q_code'] ; ?></td>
                  <td><?php if($row['qnsImage'] == 'N') { echo nl2br($row['question']); } else { ?> <img src="uploads/<?php echo $row['question'] ; ?>" alt="Question"width="100%"> <?php } ?></td>
                  <td><?php if($row['ansImage'] == 'N') { echo nl2br($row['opt1']); } else { ?> <img src="uploads/<?php echo $row['opt1'] ; ?>" alt="Option 1" width="100%"> <?php } ?></td>
                  <td><?php if($row['ansImage'] == 'N') { echo nl2br($row['opt2']); } else { ?> <img src="uploads/<?php echo $row['opt2'] ; ?>" alt="Option 1" width="100%"> <?php } ?></td>
                  <td><?php if($row['ansImage'] == 'N') { echo nl2br($row['opt3']); } else { ?> <img src="uploads/<?php echo $row['opt3'] ; ?>" alt="Option 1" width="100%"> <?php } ?></td>
                  <td><?php if($row['ansImage'] == 'N') { echo nl2br($row['opt4']); } else { ?> <img src="uploads/<?php echo $row['opt4'] ; ?>" alt="Option 1" width="100%"> <?php } ?></td>
		...
		<center> <button type="button" class="btn btn-primary" onclick="goBack()">Go Back</button> </center>
