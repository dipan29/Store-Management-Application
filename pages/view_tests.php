        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info" style="overflow-x:scroll">
            <div class="box-header">
              ...
              <h3 class="box-title">Tests - Details</h3>            
            ...
            <div class="box-body">
                ...
                <tbody>
                <?php 
					$result = mysqli_query($con, "SELECT * FROM tests ORDER BY id ");
                ...
                <tr>
                  ...
                  <td>
                  <a href="view_questions.php?id=<?php echo $row['p_code']; ?>"><button type="button" class="btn btn-primary">View</button></a> &nbsp;
                  <a href="scripts/starttest.php?id=<?php echo $row['p_code']; ?>"><button type="button" class="btn btn-success">Start</button></a>
                  <a href="scripts/endtest.php?id=<?php echo $row['p_code']; ?>"><button type="button" class="btn btn-info">Close</button></a>
                  <a href="scripts/deletetest.php?id=<?php echo $row['p_code']; ?>"><button type="button" class="btn btn-danger">DELETE</button></a>
                  </td>
                </tr>
                <?php }
				} ?>
